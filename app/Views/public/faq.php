...
<body class="bg-light">
    ...
    <div class="container py-5">
        ...
        <div class="accordion" id="faqAccordion">
            ...
            <?php 
            $items = [
                "Apa itu Chicken Sizzle?" => [
                    "Chicken Sizzle adalah UMKM kuliner yang menyediakan aneka menu ayam dengan cita rasa gurih, pedas, dan crispy. Kami berfokus pada kualitas bahan, kebersihan, serta rasa yang konsisten."
                ],
                "Apakah ChickenSizzle halal?" => [
                    "Ya, semua bahan dan proses kami 100% halal dan higienis."
                ],
                "Dimana lokasi Chicken Sizzle?" => [
                    "Kami berlokasi di [isi alamat lengkap toko]. Untuk pelanggan luar area, kami juga melayani pemesanan online."
                ],
                "Jam operasional toko?" => [
                    "Chicken Sizzle buka setiap hari: Pukul 10.00 – 22.00 WIB."
                ],
                "Apakah bisa custom level pedas?" => [
                    "Bisa! Chicken Sizzle menyediakan level pedas 0–3. Silakan pilih level saat memesan."
                ],
            ];
